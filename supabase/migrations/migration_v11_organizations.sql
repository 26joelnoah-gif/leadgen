...
CREATE TABLE IF NOT EXISTS public.organizations (
  ...
  name TEXT NOT NULL,
  slug TEXT UNIQUE NOT NULL, -- bijv. "acme-sales" → acme-sales.leadgen.app later
...
-- 3. KOPPEL LEADS AAN ORGANIZATION (voor tenant isolation)
...
-- Users zien alleen hun eigen organization
...
CREATE POLICY "leads_select_org" ON public.leads
  FOR SELECT USING (
    ...
    OR organization_id IS NULL -- backwards compat voor bestaande data
  );
...
-- =====================================================
-- KLAAR. Bestaande data blijft werken (organization_id = NULL).
-- Nieuwe users krijgen een org via de /setup pagina.
-- =====================================================
